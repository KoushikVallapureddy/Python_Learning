...
The from my_class import MyClass statement connects the my_class.py file to your program. 
The first my_class is the filename (without .py), and MyClass is the class name inside that file.
'''
